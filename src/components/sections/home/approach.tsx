...
export default function Approach() {
  ...
  return (
    <section
      ref={containerRef}
      className="w-full bg-[#0e0f12] pb-32 pt-[calc(var(--page-margin)*2)] text-[#ebe7e1] lg:pb-40"
    >
      <div className="px-page-margin">
        <div className="gap-x-grid-gutter grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12">
          ...
          <div className="col-span-4 mb-[calc(var(--page-margin)*2)] flex items-start md:col-span-2 md:mb-0 lg:col-span-3 lg:mb-0">
          ...
          {/* --- ARA BOŞLUK (Eşitlendi) --- */}
          {/* REVIZE: Buton ile aynı padding değerleri verildi */}
          <div
            className={cn(
